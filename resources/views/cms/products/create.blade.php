                        ...
                        <form id="products-create" action="@if(isset($product->id))
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price" name="price" type="number" class="form-control form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="quantity" name="quantity" type="number" class="form-control form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input id="quantity_alert" name="quantity_alert" type="number" class="form-control form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description"
                                          class="form-control form-control tiny_textarea"
